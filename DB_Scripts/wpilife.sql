...
--
-- Host: localhost
-- Generation Time: Jan 01, 2014 at 04:03 AM
...
(11, 'SELL', '<del>Tickets for Halloween Party </del>', 'halloween_party.jpg', '$13', '<p>\n CSSA will hold a party for Halloween Day this 1st Nov in Shangri-La Restaurant!\n</p>\n<p>\n $13 for each ticket!\n</p>', 2, 2013, 'October', 21, '2013-10-21 18:15:55', 0, 0, 0, 1, 1);
...
(1, 'Hao', 'hzhou@wpi.edu', '', '2013-08-05 17:44:50', 1),
(15, 'Hao ', 'zhouhao028841@126.com', 'I am Hao!', '2013-12-28 18:08:44', 1),
(16, 'I am Hao', 'zhouhao028841@126.com', 'test', '2013-12-28 18:12:13', 1);
...
(2, 'CSSA万圣狂欢PARTY~~', '<p>\n <span>亲爱滴童鞋们：</span> \n</p>\n<div>\n 万恶的MID TERM临近尾声，万圣狂欢夜即将来临！\n</div>\n<div>\n 与CSSA一起high翻万圣夜，数量有限，报名从速~~\n</div>\n<div>\n <br />\n</div>\n<div>\n <span>报名链接:</span><a href="https://docs.google.com/spreadsheet/ccc?key=0Ah6AuOpkbL-gdFM3eXdUdDl4M0l6Q2lBS2VISHhaOUE&usp=sharing" target="_blank">https://docs.google.com/spreadsheet/ccc?key=0Ah6AuOpkbL-gdFM3eXdUdDl4M0l6Q2lBS2VISHhaOUE&amp;usp=sharing</a> \n</div>\n<div>\n <br />\n</div>\n<p>\n <span>1.活动说明：</span> \n</p>\n<p>\n <span>派对时间:11月1日（周五）7pm-11pm<br />\n派对地点:香格里拉餐厅Party Hall<br />\n票价： $13刀每人<br />\n<br />\n2.活动内容：<br />\n1）PARTY节目：卡拉ok，精彩游戏，热辣舞蹈，等<br />\n2）餐饮：精美自助晚餐，包括香格里拉主打菜式，啤酒免费（鸡尾酒需个人前台买单）<br />\n<br />\n3.活动要求:<br />\nCostume required!!(想成为万众瞩目的焦点么？精心打造你的万圣节造型吧！！you will be the best!!! Showtime !!!<br />\n<br />\nPS:如有购票意向或任何问题，请联系WPI-CSSA-李晨（1134295676@qq.com&lt;mailto:如有购票意向或任何问题，请联系WPI-CSSA-李晨（1134295676@qq.com&gt;)<br />\n<br />\n</span>\n</p>\n<p>\n <span> </span>\n</p>\n<div>\n <span></span>\n</div>', 2, 2013, 'October', 20, '2013-10-21 12:47:19', 0, 0, 0, 1, 'activity');
...
CREATE TABLE IF NOT EXISTS `cssa_album` (
...
(3, 2013, 2, 'Header of IT technology team');
...
(1, 'Yafei Zhang', 'yanfeizhang.png', 'Financial Mathematics', 'yzhang7@wpi.edu', 'I love traveling and helping people. ', 0),
(2, 'Zhe Huang', 'zhuang.png', 'MBA', 'zhuang@wpi.edu', 'Leave blank...', 0),
(3, 'Hao Zhou', 'hzhou.png', 'Computer Science', 'hzhou@wpi.edu', 'I am not a good guy, never...', 0);
...
(1, 'President', '2', '0', 2013, 0),
(2, 'Vice President', '', '0', 2013, 1),
(3, 'Treasurer', '1', '', 2013, 5),
(4, 'IT', '3', '', 2013, 13);
...
CREATE TABLE IF NOT EXISTS `cssa_photograph` (
...
CREATE TABLE IF NOT EXISTS `cssa_photograph_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `cssa_photograph_type` (`id`, `name`, `sort`) VALUES
(1, 'stillLife', 0),
(2, 'LandScape ', 0),
(3, 'Animal', 0),
(4, 'People', 0),
...
(1, 'School Life', 'Who am I?', 'I am Crazy Egg! Haha', 0, 0, '0001-01-01 00:00:00', 1),
...
(1, 2, '80000000 Park Avenue, Worcester, MA, United States', '<p>\n This is for test use!\n</p>\n<p>\n <br />\n</p>\n<p>\n <img src="http://maps.googleapis.com/maps/api/staticmap?center=42.27695577257624,-71.80814152380371&zoom=14&size=558x360&maptype=roadmap&markers=42.27695577257624,-71.80814152380371&language=en&sensor=false" alt="" /> \n</p>', 2, 870, 1, 1, 0, '2013-08-31', '2013-08-27 09:27:57', 1),
(3, 2, '80 Park Avenue, Worcester, MA, United States', 'Test again!', 3, 1200, 0, 0, 0, '2014-01-01', '2014-01-01 02:46:54', 1);
...
(13, 22, 22, 1, '2013-11-13'),
(14, 23, 23, 1, '2013-11-13'),
(20, 15, 27, 1, '2013-11-16'),
(19, 15, 26, 1, '2013-11-16'),
(18, 20, 26, 1, '2013-11-16'),
(21, 18, 27, 1, '2013-11-16'),
(22, 17, 27, 1, '2013-11-16'),
...
INSERT INTO `recs` (`id`, `name`, `sort`, `status`) VALUES
(1, 'Eating', 0, 1),
(2, 'Shopping', 0, 1),
(3, 'Travelling', 0, 1),
(4, 'Car', 0, 1),
...
(1, 0, 2, 'XXXX', 'http://sbzhouhao.net/', 'NND，此刻只想对那个叫盛宽的家伙说句：“我们的友谊就这么结束了！”<p>本以为有你这个家伙垫底，我妥妥的倒二。现在好了，我都不敢以真面目现身了。</p> 本来名声就不好，现在就更臭了！<br/>'),
...
INSERT INTO `users` (`users_id`, `users_gender`, `users_firstname`, `users_lastname`, `users_photo`, `users_educational_background`, `users_major`, `users_graduate_university`, `users_status`, `users_address`, `users_country`, `users_province`, `users_city`, `users_county`, `users_dob`, `users_email_address`, `users_nick`, `users_telephone`, `users_qq`, `users_password`, `users_description`, `users_newsletter`, `users_activated`) VALUES
(1, 'm', 'CSSA', 'WPI', '', '', 'CS', '', '', '100 Institute Rode, Worcester, MA', '', '', 'Yancheng', '', '0001-01-01 ', 'wpilife@gmail.com', 'WPILIFE', '', '0', '81e2db0f6139ff8b05c4a7XXXXXXXXXX', 'Just Do It!', 0, 1),
(2, 'm', 'Hao', 'Zhou', 'wpilife_2.jpg', '', 'CS', '大连理工大学', '', '80 Park Ave, Worcester, MA', '', '', '中国江苏省盐城', '', '0001-01-01 ', 'hzhou@wpi.edu', '', '5083359815', '137044237', '81e2db0f6139ff8b05c4a7XXXXXXXXXX', ' I AM HAO! HAHA~', 0, 1),
