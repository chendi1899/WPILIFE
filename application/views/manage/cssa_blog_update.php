			...
			<h3 class="margin">Add New Blog</h3>
				...
				<section id="account">
					...
					<?php 
						...
						echo form_open('manage/cssa/blog_updates',$attibutes);
						echo form_hidden('blogs_id', $blog['blogs_id']);
					?>
						<fieldset>
						<table width="100%">
							<tr>
								<td>
									<input type="text" name="blogs_title" id="blogs_title" placeholder="Blog Title" value="<?php echo $blog['blogs_title']?>" style="width:632px;" />
								</td>
							</tr>
							<tr>
								<td><textarea name="content" cols="40" rows="3" id="content"><?php echo $blog['blogs_content']?></textarea></td>
							</tr>
							<tr>
