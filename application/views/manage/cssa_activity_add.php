			...
			<h3 class="margin">Add New Activity</h3>
				...
				<section id="account">
					...
					<?php 
						...
						echo form_open('manage/cssa/activity_adds',$attibutes);
					?>
						<fieldset>
						<table width="100%">
							<tr>
								<td>
									<input type="text" name="activities_title" id="activities_title" placeholder="Activity Title" style="width:632px;" />
								</td>
							</tr>
							<tr>
